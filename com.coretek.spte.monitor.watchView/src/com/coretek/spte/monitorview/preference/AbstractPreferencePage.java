...
import com.coretek.spte.monitor.ui.preference.StatusUtil;
...
public abstract class AbstractPreferencePage extends PreferencePage implements IWorkbenchPreferencePage
{
	...
	{
		return MsgWatchViewPlugin.getDefault().getPreferenceStore();
	}
	...
	public boolean performOk()
	{
		...
		MsgWatchViewPlugin.getDefault().savePluginPreferences();
		return true;
	}
