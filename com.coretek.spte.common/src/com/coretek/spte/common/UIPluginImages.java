 ...
 *     QNX Software System
 *******************************************************************************/
package com.coretek.spte.common;
...
public class UIPluginImages
{
	...
	// The plugin registry
	private static ImageRegistry		imageRegistry				= new ImageRegistry(SPTECommonPlugin.getStandardDisplay());
	...
	static
	{
		try
		{
			fgIconBaseURL = new URL(SPTECommonPlugin.getDefault().getBundle().getEntry("/"), "icons/");
	...
	private static final String			NAME_PREFIX					= SPTECommonPlugin.PLUGIN_ID + '.';
	 ...
	 * (non-Javadoc)
	 * 
	 * @see java.lang.Object#finalize() <br/> <b>Author</b> SunDawei </br>
	 * <b>Date</b> 2012-5-19
	 */
	@Override
