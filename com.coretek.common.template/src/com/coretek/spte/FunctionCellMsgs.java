 ...
 */
@EntityRules(xpath = "功能单元消息", xmlName = "功能单元消息", displayField = "", dragable = false, superClazz = "com.coretek.common.template.build.codeTemplate.Entity")
public class FunctionCellMsgs extends com.coretek.common.template.build.codeTemplate.Entity
{
	// 此属性对应于"NUM"
