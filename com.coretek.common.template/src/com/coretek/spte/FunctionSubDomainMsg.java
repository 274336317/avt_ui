...
/**
 * 此类对应于xml上的 "功能子域消息" 节点. 如果您不是专业人士，请不要修改此文件.
 * 
 * @author GENERATED BY SPTE_CODE_ROBOT
 */
@EntityRules(xpath = "功能子域消息", xmlName = "功能子域消息", displayField = "msgTopicName", dragable = false, superClazz = "com.coretek.common.template.build.codeTemplate.Entity")
public class FunctionSubDomainMsg extends com.coretek.common.template.build.codeTemplate.Entity
{
	// 此属性对应于"消息传输周期"
	...
	// 引用属性
	@ReferenceRules(condition = "sourceFunctionID=ID", type = "com.coretek.spte.FunctionSubDomain")
	private com.coretek.spte.FunctionSubDomain	logicParent;
	// 引用属性
	@ReferenceRules(condition = "parentMsgID=msgID", type = "com.coretek.spte.FunctionDomainMsg")
	private com.coretek.spte.FunctionDomainMsg	parentMsg;
	// 引用属性
	...
	public com.coretek.spte.FunctionDomainMsg getParentMsg()
	{
		return this.parentMsg;
	}

	public void setParentMsg(com.coretek.spte.FunctionDomainMsg parentMsg)
	{
