...
/**
 * 此类对应于xml上的 "功能子域" 节点. 如果您不是专业人士，请不要修改此文件.
 * 
 * @author GENERATED BY SPTE_CODE_ROBOT
 */
@EntityRules(xpath = "功能子域", xmlName = "功能子域", displayField = "name", dragable = false, superClazz = "com.coretek.common.template.build.codeTemplate.Entity")
public class FunctionSubDomain extends com.coretek.common.template.build.codeTemplate.Entity
{
	// 此属性对应于"归属上级通信对象ID"
	...
	// 引用属性
	@ReferenceRules(condition = "parentID=ID", type = "com.coretek.spte.FunctionDomain")
