...
/**
 * 此类对应于xml上的 "枚举值对" 节点. 如果您不是专业人士，请不要修改此文件.
 * 
 * @author GENERATED BY SPTE_CODE_ROBOT
 */
@EntityRules(xpath = "枚举值对", xmlName = "枚举值对", displayField = "", dragable = false, superClazz = "com.coretek.common.template.build.codeTemplate.Entity")
public class EnumValueAndKey extends com.coretek.common.template.build.codeTemplate.Entity
{
