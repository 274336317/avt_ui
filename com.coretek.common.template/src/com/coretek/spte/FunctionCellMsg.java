...
/**
 * 此类对应于xml上的 "功能单元消息" 节点. 如果您不是专业人士，请不要修改此文件.
 * 
 * @author GENERATED BY SPTE_CODE_ROBOT
 */
@EntityRules(xpath = "功能单元消息", xmlName = "功能单元消息", displayField = "msgTopicName", dragable = false, superClazz = "com.coretek.common.template.build.codeTemplate.Entity")
public class FunctionCellMsg extends com.coretek.common.template.build.codeTemplate.Entity
{
	// 此属性对应于"消息传输周期"
	...
	// 此属性对应于"最大传输延迟"
	@FieldRules(xmlName = "最大传输延迟", display = true, type = "Double", node = true, editable = false, textNode = false)
	private Double									maxTranDelay;
	// 此属性对应于"消息主题标识符"
	...
	// 引用属性
	@ReferenceRules(condition = "sourceFunctionID=ID", type = "com.coretek.spte.FunctionCell")
	private com.coretek.spte.FunctionCell			logicParent;
	// 引用属性
	...
	public Double getMaxTranDelay()
	{
		return this.maxTranDelay;
	}

	public void setMaxTranDelay(Double maxTranDelay)
	{
	...
	public com.coretek.spte.FunctionCell getLogicParent()
	{
		return this.logicParent;
	}

	public void setLogicParent(com.coretek.spte.FunctionCell logicParent)
	{
