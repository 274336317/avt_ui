 ...
 */
@EntityRules(xpath = "功能子域消息", xmlName = "功能子域消息", displayField = "", dragable = false, superClazz = "com.coretek.common.template.build.codeTemplate.Entity")
public class FunctionSubDomainMsgs extends com.coretek.common.template.build.codeTemplate.Entity
{
	// 此属性对应于"NUM"
