...
{
	public static final String	PREFIX								= ProjectPlugin.PLUGIN_ID + ".";							//$NON-NLS-1$
	...
	// add by yinjun 2006.11.29
	public static final String	CMONITOR_VIEW						= PREFIX + "monitor_view";									//$NON-NLS-1$
	public static final String	CMAKEFILEEDITOR_VIEW				= PREFIX + "makefile_view";								//$NON-NLS-1$
	public static final String	CPROBLEMS_VIEW						= PREFIX + "problems_view";								//$NON-NLS-1$
