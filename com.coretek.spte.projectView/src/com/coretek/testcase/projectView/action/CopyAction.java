...
public class CopyAction extends SelectionListenerAction
{
	...
	{
		super(Messages.getString("CopyAction.title")); //$NON-NLS-1$
		assert shell != null;
		...
		setId(CopyAction.ID);
		PlatformUI.getWorkbench().getHelpSystem().setHelp(this, IHelpContextIds.COPY_ACTION);
	...
	private void setClipboard(IResource[] resources, String[] fileNames, String names)
	{
		...
		} catch (SWTError e)
		{
			if (e.code != DND.ERROR_CANNOT_SET_CLIPBOARD)
				throw e;
			if (MessageDialog.openQuestion(shell, Messages.getString("CopyToClipboardProblemDialog.title"), Messages.getString("CopyToClipboardProblemDialog.message"))) //$NON-NLS-1$ //$NON-NLS-2$
