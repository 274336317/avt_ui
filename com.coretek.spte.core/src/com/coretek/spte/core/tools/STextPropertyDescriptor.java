...
public class STextPropertyDescriptor implements IPropertyDescriptor, Serializable
{
	 ...
	 */
	private transient ILabelProvider		labelProvider	= null;

	/**
	 * The object to validate the values in the cell editor, or
	 * <code>null</code> if none (the default).
	 */
	private transient ICellEditorValidator	validator;
	 ...
	 * <code>setCategory</code> method. If unset, this method returns
	 ...
	 * The <code>PropertyDescriptor</code> implementation of this
	 * <code>IPropertyDescriptor</code> method returns the value set by the
	 * <code>setDescription</code> method. If unset, this method returns
	 ...
	 * <code>IPropertyDescriptor</code> method returns the value supplied on the
	 * constructor.
	 */
	 ...
	 * The <code>SimplePropertyDescriptor</code> implementation of this
	 * <code>IPropertyDescriptor</code> method returns the value set by the
	 * <code>setFilterFlags</code> method. If unset, this method returns
	 * <code>null</code>.
	 * <p>
	 ...
	 * The <code>SimplePropertyDescriptor</code> implementation of this
	 * <code>IPropertyDescriptor</code> method returns the value set by the
	 * <code>setHelpContextId</code> method. If unset, this method returns
	 * <code>null</code>.
	 * 
	 ...
	 * 
	 * @return the validator used to verify correct values for this property, or
	 *         <code>null</code>
	 */
	 ...
	 * property has the same id and category and
	 * <code>getAlwaysIncompatible()</code> returns false
	 */
	 ...
	 * 
	 * @param category the category for the descriptor, or <code>null</code> if
	 *            none
	 * @see #getCategory
	 */
