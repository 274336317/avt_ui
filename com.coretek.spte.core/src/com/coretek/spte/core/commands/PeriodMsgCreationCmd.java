 ...
 * 
 */
public class PeriodMsgCreationCmd extends AbstractCreationConnCmd
{

	public PeriodMsgCreationCmd(boolean isCycle, RootContainerMdl root)
	{
		super(isCycle, root);
	}

	public PeriodMsgCreationCmd()
	{
	...
	public void execute()
	{
		...
		if (this.connection != null)
		{
			...
			this.updateIdSet((MsgConnMdl) conn, "测试工具", true);
		}
