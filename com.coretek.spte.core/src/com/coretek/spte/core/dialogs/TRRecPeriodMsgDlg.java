 ...
 * 
 */
public class TRRecPeriodMsgDlg extends PeriodResultDialog
{
	...
	public TRRecPeriodMsgDlg(Shell shell, SPTEMsg spteMsg, ClazzManager icdManager, List<Entity> testedObjectsOfICD, CompareResult compareResult, Result result)
	{
		super(shell, null, spteMsg, icdManager, testedObjectsOfICD, compareResult);
		this.compareResult = compareResult;
		this.result = result;
		this.type = SPTEConstants.MESSAGE_TYPE_RECEIVE;
	...
	protected void configureShell(Shell newShell)
	{
		...
		newShell.setText(Messages.getString("VIEW_PERIOD_RECV_MSG"));
	}
	...
	private void makeReviseLabel(Composite body)
	{
		...
		this.lblRevise.setText(StringUtils.concat(Messages.getString("I18N_PERIOD_RIVISE"), ":"));
	...
	private void makeRecvLabel(Composite body)
	{
		...
		this.lblNum.setText(StringUtils.concat(Messages.getString("I18N_RECV_CONUT"), ":"));
		GridData data = new GridData();
		data.widthHint = 80;
	...
	private void makeSendLabel(Composite body)
	{
		...
		this.lblSendID.setText(StringUtils.concat(Messages.getString("I18N_SEND_ID"), ":"));
		GridData data = new GridData();
		data.widthHint = 80;
	...
	private void createMessageAttrItems(Composite area)
	{
		...
		label.setText(StringUtils.concat(Messages.getString("I18N_DESCRIBE"), ":"));
		data = new GridData();
		data.widthHint = 60;
	...
	private class LabelProvider implements ITableLabelProvider
	{
		...
		public String getColumnText(Object element, int columnIndex)
		{
			...
			switch (columnIndex)
			{
				...
				case 1:
				{// 期望值
					if (result.getErrorTypes().indexOf(ErrorTypesEnum.UNEXPECTED) >= 0)
					{// 未预期消息没有期望值
